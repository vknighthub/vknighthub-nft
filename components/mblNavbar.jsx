...
import { ALLNFT, ARTNFT, COLLECTIBLESNFT, DOMAINNAMESNFT, MUSICNFT, PHOTOGRAPHYNFT, SPORTSNFT, TRADINGCARDSNFT, UTILITYNFT, VIRTUALWORLDSNFT } from "./menuicon";
...
const MblNavbar = ({ theme }) => {
  ...
  useEffect(() => {
    ...
    if (navItemValue > 1 && navItemValue <= 19) {
      setnavText("pages");
  ...
  const menu_primary = [
    {
      ...
      submenu: [
        ...
        },
        {
          id: 3,
          text: "Collectibles",
          href: "/collection/collectibles",
          menuicon: <COLLECTIBLESNFT />
        },
        {
          id: 4,
          text: "Domain Names",
          href: "/collection/domainname",
          menuicon: <DOMAINNAMESNFT />
        },
        {
          id: 5,
          text: "Music",
        ...
        },
        {
          id: 8,
          text: "Trading Cards",
          href: "/collection/tradingcards",
          menuicon: <TRADINGCARDSNFT />
        },
        {
          id: 9,
          text: "Utility",
          href: "/collection/utility",
          menuicon: <UTILITYNFT />
        },
        {
          id: 10,
          text: "Virtual Worlds",
          href: "/collection/virtualworlds",
          menuicon: <VIRTUALWORLDSNFT />
        },
        ...
        <ul className="flex flex-col lg:flex-row">
          {menu_primary.map((menu, index) => (
            <li className="js-nav-dropdown group relative" key={index}>
              ...
              >
                <span className={navText === menu.navText ? "text-accent" : ""}>
                  {menu.name}
                </span>
              ...
              {menu.submenu.length > 0 &&
                <ul className={menu.classname} aria-labelledby="navDropdown-1">
                  {menu.submenu.map(({ id, text, href, menuicon }) => {
                    return (
                      <li key={id}>
                        <Link href={href}>
                          <a

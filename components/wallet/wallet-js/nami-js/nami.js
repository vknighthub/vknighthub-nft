...
class NamiWalletApi {
    ...
    async getBalance() {
        ...
        const minAda = this.S.min_ada_required(countedValue, true, this.S.BigNum.from_str("0"));
    ...
    async _txBuilder({
        ...
        const txConfig =  this.S.TransactionBuilderConfigBuilder.new()
            .coins_per_utxo_word(
                this.S.BigNum.from_str(ProtocolParameter.coinsPerUtxoWord)
            )
            .fee_algo(
            ...
            .key_deposit( this.S.BigNum.from_str(ProtocolParameter.keyDeposit.toString()))
            .pool_deposit( this.S.BigNum.from_str(ProtocolParameter.poolDeposit.toString()))
